...
abstract class BaseRoutesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'origin_event_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Origin_Events'), 'add_empty' => true)),
      ...
      'destination_event_id'  => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Destination_Events'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'origin_event_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Origin_Events'), 'column' => 'event_id')),
      ...
      'destination_event_id'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Destination_Events'), 'column' => 'event_id')),
  ...
  public function getFields()
  {
    return array(
      ...
      'destination_event_id'  => 'ForeignKey',
      'distance'              => 'Number',
      'duration'              => 'Number',
      'created_at'            => 'Date',
      'updated_at'            => 'Date',
