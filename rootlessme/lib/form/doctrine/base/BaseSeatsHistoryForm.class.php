...
abstract class BaseSeatsHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'seat_request_type_id' => new sfWidgetFormInputText(),
      'solo_route_id'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'seat_request_type_id' => new sfValidatorInteger(),
      'solo_route_id'        => new sfValidatorInteger(array('required' => false)),
