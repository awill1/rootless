...
<div>
    <p id="footerPages">
        ...
        <br/>
        <br/>
        1.4 Our Address-Verification Tool. Our "verification" tool is intended merely to confirm that the postal address a user submits to us is an address at which such user receives mail. While this is one of many ways to reduce the risk of misconduct by such user, it is not a guarantee of the user’s identity or good faith or even that the address verified is really the user’s actual residential address.
        <br/>
        <br/>
        1.5 Release. Because our Site is merely a venue, in the event that you have a dispute with one or more users, you release us (and our officers, directors, members, employees, agents and affiliates) from claims, demands and damages (actual and consequential) of every kind and nature, known and unknown, suspected and unsuspected, disclosed and undisclosed, arising out of or in any way connected with such disputes. If you are a California resident, you waive California Civil Code 1542, which says: "A general release does not extend to claims which the creditor does not know or suspect to exist in his favor at the time of executing the release, which if known by him must have materially affected his settlement with the debtor."
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        (h) provides a link to any commercial websites
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        7.2 Your Use of Our Intellectual Property. You may not systematically retrieve data or other content from our Site to create or compile, directly or indirectly, in single or multiple downloads, a collection, compilation, database, directory or the like, whether by manual methods, through the use of "bots" or otherwise. You may not use of any of our trademarks as metatags on other websites, written materials or otherwise. You may not display any portion of our Site in a frame (or any content from our Site through in-line links) without our prior written consent, which may be requested by contacting us at help@rootless.me. You may, however, establish ordinary links to the homepage of our Site without our written permission.
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        16. REPORTING MISCONDUCT. If you ride with or drive anyone who you feel is acting or has acted inappropriately, including but not limited to offensive, violent or sexually inappropriate behavior, who steals from you or engages in any other disturbing conduct, you must immediately report such person to the appropriate authorities and to us by contacting us using the form at Contact Us and choosing "Problem with Another Member"; provided that your report shall not obligate us to take any action or cause us to incur any liability.
        <br/>
        <br/>
        17. MEETINGS. Many in-person meetings are held by groups of interested members and are not sponsored or organized by us. Members who organize meetings should make clear in their announcements, invitations and signage that their meetings have not been organized or approved, and are not run, by us. We cannot guarantee the quality, organization or safety of any in-person meeting (whether or not sponsored by us). Members attend meetings at their own risk.
        <br/>
        <br/>
