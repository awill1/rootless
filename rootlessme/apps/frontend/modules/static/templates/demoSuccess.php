...
<div>
    ...
    <p>
        ...
        world. Send your feedback to
        <a href="mailto:contact@rootless.me">contact@rootless.me</a>. 
    </p>
    <p>    
        Please understand this is just a demo website. Anything you create 
        ...
        for our launch. We have two different demo options for you.
    </p>
    <h2>Guided Demo</h2>
    <p>
        ...
        <ol>
            ...
            <li>Compare the rides to find a best match. Notice how rootless.me
                ...
                origin and destination are convenient enough to a driver's 
            ...
            <li>Ask for a seat with the best ride match. Make sure to enter the
                exact addresses where you want to be picked up 
            ...
            <li>
                Imagine your ride to Chicago went very well. The driver was nice,
                on time, and it was overall a really positive experience. You 
                should review the driver so their reputation in the rootless.me 
            ...
            <li>
                ...
                any international rides in our demo database, but it is important
                to know we can support ridesharing in other countries.
            </li>
        </ol>
    </p>
