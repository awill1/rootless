    ...
    <div id="seatInfo">
        <div id="seatInfoPadder">
            ...
            <div id="editSeatTerms">
                ...
                <p><span>Price:</span> <?php echo $form['price']->render(array('class'=>'editSeatFields editSeatFieldsShort')) ?><span class='editSeat-dollar-sign' style='font-weight: normal;'>$</span> per seat</p>
