{
    ...
    "end_date": "2013-08-07",
    "results": [
        <?php foreach ($dates as $dateIndex => $date) : ?>
        {
            "date" : "<?php echo $date; ?>",
            "rides" : [
                <?php foreach ($rides as $rideIndex => $ride) : ?>
                {
                    "id": <?php echo $ride->getRideId(); ?>,
                    "is_driver": true,
                    "is_passenger": false,
                    "start_date": <?php echo $ride->getStartDate(); ?>,
                    "start_time": <?php echo $ride->getStartTime(); ?>,
                    "asking_price": <?php echo $ride->getAskingPrice(); ?>,
                    "seat_count": <?php echo $ride->getSeatCount(); ?>, 
                    "person" : {
                        "id": 1,
                        "first_name": "Aaron",
                        "last_name": "Williams",
