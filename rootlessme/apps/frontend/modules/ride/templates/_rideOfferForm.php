...
<form id="rideOfferForm" class="userInputForm newRideForm" action="<?php echo url_for(($form->getObject()->isNew() ? 'ride_create' : 'ride_update'), (!$form->getObject()->isNew() ? array('ride_type' => 'offer', 'ride_id' => $form->getObject()->getRideId()) : array('ride_type' => 'offer'))) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
