...
<img id="rideMapImage" src="http://maps.google.com/maps/api/staticmap?size=453x305&path=weight:3|color:green|<?php echo $origin->getLatitude() ?>,<?php echo $origin->getLongitude() ?>|<?php echo $destination->getLatitude() ?>,<?php echo $destination->getLongitude() ?>&sensor=false" alt="Interactive Map" />
