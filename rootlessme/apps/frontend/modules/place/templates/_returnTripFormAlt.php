<form id="roundTripForm" action="<?php echo url_for('place_create_ride') ?>" method="post">
  ...
  <div class="formSection">  
      <div id="iAmA"><span class="primaryTextStyle">I am a</span>
            <input id="rideTypeDriver" class="trackableClickField" type="radio" name="ride_type" value="driver" />
      ...
      <div id="startingFrom">
            ...
            <input id="originTextBox" class="longField trackableField required" type="text" name="origin" placeholder="Address, City, State" />
      </div>
  </div>
  ...
  <div class="formSection">
      <div id="departDate">
            <span class="primaryTextStyle">Depart Date</span>
                <input id="startDateTextBox" class="datePicker shortField trackableField date" type="text" name="start_date" placeholder="MM/DD/YYYY" />
                ...
                <br />
                <input id="startDateAnydayCheckBox" class="trackableClickField" type="checkbox" name="start_date_any" />
      ...
      <div id="returnDate">
            <span class="primaryTextStyle">Return Date</span>
                <input id="returnDateTextBox" class="datePicker shortField trackableField date" type="text" name="return_date" placeholder="MM/DD/YYYY" />
                ...
                <br />
                <input id="returnDateAnydayCheckBox" class="trackableClickField" type="checkbox" name="return_date_any" />
  ...
  <div class="formSection">
        ...
        <span class="primaryTextStyle">Seats Available</span>
            ...
            <span class='dollar-sign'>$</span> <input id="driverPriceTextBox" class="tinyField trackableField number" type="text" name="driver_price" /> <span class='fourthTextStyle'>per seat</span>
        </div>   
  </div>
  <div class="formSection"><hr class="placeFormHr"/></div>
  <div class="formSection">
            ...
            <div id="seatsNeeded">
                ...
                <span class='dollar-sign'>$</span> <input id="passengerPriceTextBox" class="tinyField trackableField number" type="text" name="passenger_price" /> <span class='fourthTextStyle'>per seat</span>
            </div>
