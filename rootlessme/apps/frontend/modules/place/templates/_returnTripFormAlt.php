<form id="roundTripForm" action="<?php echo url_for('place_create_ride') ?>" method="post">
  ...
  <div class="formSection">  
      ...
      <div id="startingFrom">
          ...
          <div id="startingFromInput"><input id="originTextBox" class="longField required" type="text" name="origin" placeholder="Address, City, State" /></div>
      </div>
  </div>
  ...
  <div class="formSection">
      <div id="departDate">
          ...
          <div id="departDateInput"><input id="startDateTextBox" class="datePicker shortField date" type="text" name="start_date" placeholder="MM/DD/YYYY" /></div>
      ...
      <div id="returnDate">
          ...
          <div id="returnDateInput"><input id="returnDateTextBox" class="datePicker shortField date" type="text" name="return_date" placeholder="MM/DD/YYYY" /></div>
  ...
  <div class="formSection">
            ...
            <div id="seatsNeeded">
                ...
                <div id="willingToPayInput"><span class='dollar-sign'>$</span> <input id="passengerPriceTextBox" class="tinyField number" type="text" name="passenger_price" /> <span class='fourthTextStyle'>per seat</span></div>
            </div>
        <br/><br/><br/>
